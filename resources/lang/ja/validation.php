...
return [
    ...
    */
    ...
    'custom' => [
        'subject' => [
            'required' => '「件名」は必ず選択してください！',
            'subject' => '「件名」は選択肢から選んでください！',
        ],
        'name' => [
            'required' => '「名前」は必ず入力してください！',
            'max' => '「名前」は50文字以内で入力してください！',
        ],
        'email' => [
            'required' => '「メールアドレス」は必ず入力してください！',
            'c_mail' => '「メールアドレス」を正式に入力してください！',
        ],
        'tel' => [
            'required' => '「電話番号」は必ず入力してください！',
            'digits_between' => '「電話番号」を正式に入力してください！',
        ],
        'contents' => [
            'required' => '「お問い合わせ内容」は必ず入力してください！',
            'max' => '「お問い合わせ内容」は255文字以内で入力してください！',
        ],
    ],
